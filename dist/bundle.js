...
var _CardEntryForm = __webpack_require__(7);

var _CardEntryForm2 = _interopRequireDefault(_CardEntryForm);
...
var Header = _styledComponents2.default.h1(_templateObject, _styles.colors.black);
var Wrapper = _styledComponents2.default.div(_templateObject2);

var Title = _styledComponents2.default.h1(_templateObject3, _styles.fonts.primary, function (props) {
  return props.bold ? 700 : 100;
});

var SubTitle = _styledComponents2.default.h3(_templateObject4, _styles.fonts.primary, function (props) {
  return props.bold ? 700 : 100;
});

var Cards = _styledComponents2.default.p(_templateObject5);

var Flex = _styledComponents2.default.div(_templateObject6, function (props) {
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.handleSend = function (values) {
      fetch('/api/count', {
        method: 'POST',
    ...
    value: function componentDidMount() {
      ...
      if (!window["WebSocket"]) {
        ...
        this.socket.onmessage = function (e) {
          ...
          _this2.setState({ cards: _this2.state.cards + entry.count });
        };
      }
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            Title,
            { bold: true },
            'Elevating the level of gratitude on the planet by 1%.'
          ),
          (0, _preact.h)(
            Title,
            null,
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            SubTitle,
            null,
            'Cards sent to date. Submit yours: '
          ),
          (0, _preact.h)(_CardEntryForm2.default, { onSubmit: this.handleSend })
        )
      );
    }
  }]);
...
var Input = _styledComponents2.default.input(_templateObject2, function (props) {
  return props.error ? '2px solid' : 'none';
}, function (props) {
  return props.error ? _styles.colors.red : '';
});

var Button = _styledComponents2.default.button(_templateObject3, _styles.fonts.primary, _styles.colors.red);

var CardEntryForm = function (_Component) {
  _inherits(CardEntryForm, _Component);

  function CardEntryForm(props) {
    _classCallCheck(this, CardEntryForm);

    var _this = _possibleConstructorReturn(this, (CardEntryForm.__proto__ || Object.getPrototypeOf(CardEntryForm)).call(this, props));

    _this.handleChange = function (prop, e) {
      _this.setState(_defineProperty({}, prop, e.target.value));
    };
    ...
    _this.handleSubmit = function (e) {
      ...
      _this.props.onSubmit({
        ...
        count: parseInt(_this.state.count, 10)
      });
      _this.setState({ email: '', name: '', count: '', errors: {} });
    };

    _this.handleBlur = function (field, e) {
      var val = e.target.value;

      if (val.length === 0) {
        _this.setState({ errors: _extends({}, _this.state.errors, _defineProperty({}, field, true)) });
      } else {
        _this.setState({ errors: _extends({}, _this.state.errors, _defineProperty({}, field, false)) });
      }
    };

    _this.state = { email: '', name: '', count: '', errors: {} };
    return _this;
  }

  _createClass(CardEntryForm, [{
    key: 'render',
    value: function render() {
      var errors = this.state.errors;

      var hasError = errors.email || errors.name || errors.count;
